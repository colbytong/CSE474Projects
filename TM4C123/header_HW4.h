// HW 4 custom header file

#define RCC                     (*((volatile uint32_t *)0x400FE060))
#define RCGC0                   (*((volatile uint32_t *)0x400FE100))
...
#define GPIOPCTL_PORTB          (*((volatile uint32_t *)0x4000552C))
#define GPIODR2R                (*((volatile uint32_t *)0x40005500))
#define GPIOSLR                 (*((volatile uint32_t *)0x40005518))
// PWM configuration
